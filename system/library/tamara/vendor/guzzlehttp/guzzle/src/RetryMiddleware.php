...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\TMS\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\TMS\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\TMS\Psr\Http\Message\RequestInterface $request, array $options, \TMS\Psr\Http\Message\ResponseInterface $response = null)
    {
