...
final class TransferStats
{
     ...
     */
    public function __construct(\TMS\Psr\Http\Message\RequestInterface $request, ?\TMS\Psr\Http\Message\ResponseInterface $response = null, ?float $transferTime = null, $handlerErrorData = null, array $handlerStats = [])
    {
     ...
     */
    public function getEffectiveUri() : \TMS\Psr\Http\Message\UriInterface
    {
