...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \TMS\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\TMS\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\TMS\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\TMS\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\TMS\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
