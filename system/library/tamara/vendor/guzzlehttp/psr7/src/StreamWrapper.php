...
class StreamWrapper
{
     ...
     */
    public static function getResource(\TMS\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\TMS\Psr\Http\Message\StreamInterface $stream)
    {
