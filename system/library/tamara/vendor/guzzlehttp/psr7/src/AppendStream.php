 ...
 * @final
 */
class AppendStream implements \TMS\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\TMS\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \TMS\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
