 ...
 * @final
 */
class FnStream implements \TMS\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\TMS\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
