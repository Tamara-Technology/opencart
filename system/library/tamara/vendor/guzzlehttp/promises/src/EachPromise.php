 ...
 */
class EachPromise implements \TMS\GuzzleHttp\Promise\PromisorInterface
{
    private $pending = [];
    ...
    {
        $this->iterable = \TMS\GuzzleHttp\Promise\Create::iterFor($iterable);
    ...
    private function createPromise()
    {
        ...
        $this->aggregate = new \TMS\GuzzleHttp\Promise\Promise(function () {
            ...
            while ($promise = \current($this->pending)) {
                \next($this->pending);
                $promise->wait();
                if (\TMS\GuzzleHttp\Promise\Is::settled($this->aggregate)) {
                    return;
                }
            }
        });
    ...
    private function addPending()
    {
        ...
        $promise = \TMS\GuzzleHttp\Promise\Create::promiseFor($this->iterable->current());
