...
class AuthoriseOrderResponse extends \TMS\Tamara\Response\ClientResponse
{
    private const ORDER_ID = 'order_id', STATUS = 'status', ORDER_EXPIRY_TIME = 'order_expiry_time';
    /**
     * @var string|null
     */
    private $orderId;
