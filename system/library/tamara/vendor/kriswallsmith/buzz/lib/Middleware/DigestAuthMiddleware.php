...
class DigestAuthMiddleware implements \TMS\Buzz\Middleware\MiddlewareInterface
{
    private $username;
    private $password;
    private $realm;
     ...
     */
    private function parseServerHeaders(\TMS\Psr\Http\Message\ResponseInterface $response) : void
    {
