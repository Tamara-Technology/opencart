...
trait MessageTrait
{
    ...
    public function getBody() : \TMS\Psr\Http\Message\StreamInterface
    {
        if (null === $this->stream) {
            $this->stream = \TMS\Nyholm\Psr7\Stream::create('');
        }
        return $this->stream;
    }
    public function withBody(\TMS\Psr\Http\Message\StreamInterface $body) : self
    {
        if ($body === $this->stream) {
            return $this;
        }
