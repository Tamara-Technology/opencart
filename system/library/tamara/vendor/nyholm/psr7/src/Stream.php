...
use TMS\Symfony\Component\Debug\ErrorHandler as SymfonyLegacyErrorHandler;
use TMS\Symfony\Component\ErrorHandler\ErrorHandler as SymfonyErrorHandler;
/**
 ...
 */
class Stream implements \TMS\Psr\Http\Message\StreamInterface
{
     ...
     */
    public static function create($body = '') : \TMS\Psr\Http\Message\StreamInterface
    {
        if ($body instanceof \TMS\Psr\Http\Message\StreamInterface) {
            return $body;
        }
        if (\is_string($body)) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($e instanceof \Error || $errorHandler instanceof \TMS\Symfony\Component\ErrorHandler\ErrorHandler || $errorHandler instanceof \TMS\Symfony\Component\Debug\ErrorHandler) {
