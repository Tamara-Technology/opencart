 ...
 */
namespace TMS\Symfony\Component\String\Slugger;

use TMS\Symfony\Component\String\AbstractUnicodeString;
use TMS\Symfony\Component\String\UnicodeString;
use TMS\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\TMS\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \TMS\Symfony\Component\String\Slugger\SluggerInterface, \TMS\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \TMS\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \TMS\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
