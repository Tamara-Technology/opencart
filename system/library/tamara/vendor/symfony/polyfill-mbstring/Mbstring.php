 ...
 */
namespace TMS\Symfony\Polyfill\Mbstring;
...
final class Mbstring
{
    ...
    public static function mb_internal_encoding($encoding = null)
    {
        ...
        throw new \TMS\ValueError(\sprintf('Argument #1 ($encoding) must be a valid encoding, "%s" given', $encoding));
    }
    public static function mb_language($lang = null)
    {
        ...
        throw new \TMS\ValueError(\sprintf('Argument #1 ($language) must be a valid language, "%s" given', $lang));
    }
    ...
    public static function mb_str_split($string, $split_length = 1, $encoding = null)
    {
        ...
        if (1 > ($split_length = (int) $split_length)) {
            ...
            throw new \TMS\ValueError('Argument #2 ($length) must be greater than 0');
        }
        if (null === $encoding) {
    ...
    public static function mb_substitute_character($c = null)
    {
        ...
        throw new \TMS\ValueError('Argument #1 ($substitute_character) must be "none", "long", "entity" or a valid codepoint');
    }
