 ...
 */
use TMS\Symfony\Polyfill\Php80 as p;
...
if (!\function_exists('TMS\\fdiv')) {
    function fdiv(float $num1, float $num2) : float
    {
        return \TMS\Symfony\Polyfill\Php80\Php80::fdiv($num1, $num2);
    }
}
if (!\function_exists('TMS\\preg_last_error_msg')) {
    function preg_last_error_msg() : string
    {
        return \TMS\Symfony\Polyfill\Php80\Php80::preg_last_error_msg();
    }
}
...
if (!\function_exists('TMS\\get_debug_type')) {
    ...
    {
        return \TMS\Symfony\Polyfill\Php80\Php80::get_debug_type($value);
    }
}
if (!\function_exists('TMS\\get_resource_id')) {
    function get_resource_id($resource) : int
    {
        return \TMS\Symfony\Polyfill\Php80\Php80::get_resource_id($resource);
    }
}
