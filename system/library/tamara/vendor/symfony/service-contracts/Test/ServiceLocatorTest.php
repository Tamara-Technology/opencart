 ...
 */
namespace TMS\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends \TMS\PHPUnit\Framework\TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\TMS\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\TMS\Psr\Container\ContainerExceptionInterface::class);
