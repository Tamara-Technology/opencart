...
use TMS\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder;
/**
 * An abstract base MIME Header.
 *
 * @author Chris Corbyn
 */
abstract class AbstractHeader implements \TMS\Symfony\Component\Mime\Header\HeaderInterface
{
     ...
     */
    protected function createPhrase(\TMS\Symfony\Component\Mime\Header\HeaderInterface $header, string $string, string $charset, bool $shorten = \false) : string
    {
     ...
     */
    protected function encodeWords(\TMS\Symfony\Component\Mime\Header\HeaderInterface $header, string $input, int $usedLength = -1) : string
    {
        $value = '';
    ...
    protected function getTokenAsEncodedWord(string $token, int $firstLineOffset = 0) : string
    {
        if (null === self::$encoder) {
            self::$encoder = new \TMS\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
        }
