 ...
 * @author Chris Corbyn
 */
final class MailboxListHeader extends \TMS\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\TMS\Symfony\Component\Mime\Address $address)
    {
