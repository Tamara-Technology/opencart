 ...
 * @author Chris Corbyn
 */
final class IdentificationHeader extends \TMS\Symfony\Component\Mime\Header\AbstractHeader
{
    private $ids = [];
    ...
    public function setIds(array $ids)
    {
        ...
        $this->idsAsAddresses = [];
        foreach ($ids as $id) {
            $this->idsAsAddresses[] = new \TMS\Symfony\Component\Mime\Address($id);
            $this->ids[] = $id;
        }
    }
    /**
