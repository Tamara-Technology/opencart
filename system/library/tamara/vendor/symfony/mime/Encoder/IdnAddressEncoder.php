 ...
 */
namespace TMS\Symfony\Component\Mime\Encoder;

use TMS\Symfony\Component\Mime\Exception\AddressEncoderException;
/**
 ...
 */
final class IdnAddressEncoder implements \TMS\Symfony\Component\Mime\Encoder\AddressEncoderInterface
{
    /**
    ...
    public function encodeString(string $address) : string
    {
        ...
        if (\false !== $i) {
            ...
            if (\preg_match('/[^\\x00-\\x7F]/', $local)) {
                throw new \TMS\Symfony\Component\Mime\Exception\AddressEncoderException(\sprintf('Non-ASCII characters not supported in local-part os "%s".', $address));
            }
