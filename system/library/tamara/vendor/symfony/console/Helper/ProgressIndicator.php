...
class ProgressIndicator
{
    ...
    public function __construct(\TMS\Symfony\Component\Console\Output\OutputInterface $output, string $format = null, int $indicatorChangeInterval = 100, array $indicatorValues = null)
    {
        ...
        if (2 > \count($indicatorValues)) {
            throw new \TMS\Symfony\Component\Console\Exception\InvalidArgumentException('Must have at least 2 indicator value characters.');
        }
    ...
    private static function initPlaceholderFormatters() : array
    {
        return ['indicator' => function (self $indicator) {
            ...
            return \TMS\Symfony\Component\Console\Helper\Helper::formatTime(\time() - $indicator->startTime);
        }, 'memory' => function () {
