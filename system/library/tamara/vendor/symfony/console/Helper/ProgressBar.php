...
final class ProgressBar
{
    ...
    public function setMaxSteps(int $max)
    {
        $this->format = null;
        $this->max = \max(0, $max);
        $this->stepWidth = $this->max ? \TMS\Symfony\Component\Console\Helper\Helper::strlen((string) $this->max) : 4;
    }
    /**
    ...
    {
        if (\TMS\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET === $this->output->getVerbosity()) {
            return;
        }
        if (null === $this->format) {
            ...
            if (null !== $this->previousMessage) {
                if ($this->output instanceof \TMS\Symfony\Component\Console\Output\ConsoleSectionOutput) {
                    ...
                    foreach ($messageLines as $messageLine) {
                        $messageLineLength = \TMS\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->output->getFormatter(), $messageLine);
    ...
    private function determineBestFormat() : string
    {
        switch ($this->output->getVerbosity()) {
            ...
            case \TMS\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE:
                return $this->max ? 'verbose' : 'verbose_nomax';
            case \TMS\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE:
                return $this->max ? 'very_verbose' : 'very_verbose_nomax';
            case \TMS\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_DEBUG:
    ...
    {
        return ['bar' => function (self $bar, \TMS\Symfony\Component\Console\Output\OutputInterface $output) {
            ...
            return \TMS\Symfony\Component\Console\Helper\Helper::formatTime(\time() - $bar->getStartTime());
    ...
    private function buildLine() : string
    {
        ...
        $linesLength = \array_map(function ($subLine) {
            return \TMS\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->output->getFormatter(), \rtrim($subLine, "\r"));
        }, \explode("\n", $line));
