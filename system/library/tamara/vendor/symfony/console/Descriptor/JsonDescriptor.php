 ...
 * @internal
 */
class JsonDescriptor extends \TMS\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\TMS\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \TMS\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\TMS\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\TMS\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\TMS\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
