 ...
 */
class RequestMatcher implements \TMS\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\TMS\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\TMS\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
