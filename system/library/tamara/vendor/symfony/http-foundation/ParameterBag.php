...
class ParameterBag implements \IteratorAggregate, \Countable
{
    ...
    public function all()
    {
        ...
        if (!\is_array($value = $this->parameters[$key] ?? [])) {
            throw new \TMS\Symfony\Component\HttpFoundation\Exception\BadRequestException(\sprintf('Unexpected value for parameter "%s": expecting "array", got "%s".', $key, get_debug_type($value)));
        }
        return $value;
    }
    /**
