...
\class_exists(\TMS\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    public function send()
    {
        $this->sendHeaders();
        $this->sendContent();
        if (\function_exists('TMS\\fastcgi_finish_request')) {
     ...
     * @final
     */
    public function isNotModified(\TMS\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\TMS\Symfony\Component\HttpFoundation\Request $request) : void
    {
