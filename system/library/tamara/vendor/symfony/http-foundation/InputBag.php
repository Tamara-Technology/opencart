...
use TMS\Symfony\Component\HttpFoundation\Exception\BadRequestException;
/**
 * InputBag is a container for user input values such as $_GET, $_POST, $_REQUEST, and $_COOKIE.
 *
 * @author Saif Eddin Gmati <saif.gmati@symfony.com>
 */
final class InputBag extends \TMS\Symfony\Component\HttpFoundation\ParameterBag
{
    /**
    ...
    public function get(string $key, $default = null)
    {
        ...
        if (null !== $value && $this !== $value && !\is_scalar($value) && !(\is_object($value) && \method_exists($value, '__toString'))) {
            trigger_deprecation('symfony/http-foundation', '5.1', 'Retrieving a non-string value from "%s()" is deprecated, and will throw a "%s" exception in Symfony 6.0, use "%s::all($key)" instead.', __METHOD__, \TMS\Symfony\Component\HttpFoundation\Exception\BadRequestException::class, __CLASS__);
        }
