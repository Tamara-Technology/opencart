 ...
 */
class HttpException extends \TMS\Http\Client\Exception\RequestException
{
    /**
     ...
     */
    public function __construct($message, \TMS\Psr\Http\Message\RequestInterface $request, \TMS\Psr\Http\Message\ResponseInterface $response, \Exception $previous = null)
    {
     ...
     */
    public static function create(\TMS\Psr\Http\Message\RequestInterface $request, \TMS\Psr\Http\Message\ResponseInterface $response, \Exception $previous = null)
    {
