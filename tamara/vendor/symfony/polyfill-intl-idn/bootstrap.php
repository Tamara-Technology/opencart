...
if (\PHP_VERSION_ID < 70400) {
    if (!\function_exists('idn_to_ascii')) {
        ...
        {
            return \TMS\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii($domain, $flags, $variant, $idna_info);
        }
    }
    if (!\function_exists('idn_to_utf8')) {
        function idn_to_utf8($domain, $flags = 0, $variant = \INTL_IDNA_VARIANT_2003, &$idna_info = null)
        {
            return \TMS\Symfony\Polyfill\Intl\Idn\Idn::idn_to_utf8($domain, $flags, $variant, $idna_info);
        }
    }
} else {
    if (!\function_exists('idn_to_ascii')) {
