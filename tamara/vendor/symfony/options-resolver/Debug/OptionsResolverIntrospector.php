 ...
 */
namespace TMS\Symfony\Component\OptionsResolver\Debug;

use TMS\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
...
{
    private $get;
    public function __construct(\TMS\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \TMS\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \TMS\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
