...
class Email extends \TMS\Symfony\Component\Mime\Message
{
    ...
    private function generateBody() : \TMS\Symfony\Component\Mime\Part\AbstractPart
    {
        ...
        if ($inlineParts) {
            $part = new \TMS\Symfony\Component\Mime\Part\Multipart\RelatedPart($part, ...$inlineParts);
        }
        if ($attachmentParts) {
            if ($part) {
                $part = new \TMS\Symfony\Component\Mime\Part\Multipart\MixedPart($part, ...$attachmentParts);
            } else {
                $part = new \TMS\Symfony\Component\Mime\Part\Multipart\MixedPart(...$attachmentParts);
            }
        }
        return $part;
    }
