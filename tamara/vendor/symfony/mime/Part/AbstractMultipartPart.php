 ...
 */
abstract class AbstractMultipartPart extends \TMS\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\TMS\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
