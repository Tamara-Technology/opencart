...
use TMS\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
/**
 * @author Chris Corbyn
 */
final class ParameterizedHeader extends \TMS\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-type' !== \strtolower($name)) {
            $this->encoder = new \TMS\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }
