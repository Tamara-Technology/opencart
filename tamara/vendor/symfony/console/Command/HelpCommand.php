 ...
 */
class HelpCommand extends \TMS\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
...
EOF
    ...
    public function setCommand(\TMS\Symfony\Component\Console\Command\Command $command)
    {
