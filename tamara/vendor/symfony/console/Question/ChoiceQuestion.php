 ...
 */
class ChoiceQuestion extends \TMS\Symfony\Component\Console\Question\Question
{
    private $choices;
    ...
    private function getDefaultValidator() : callable
    {
        ...
        return function ($selected) use($choices, $errorMessage, $multiselect, $isAssoc) {
            ...
            foreach ($selectedChoices as $value) {
                ...
                if (\count($results) > 1) {
                    throw new \TMS\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('The provided answer is ambiguous. Value should be one of "%s".', \implode('" or "', $results)));
                }
