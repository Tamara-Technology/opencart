...
class TamaraScanOrder extends TamaraAbstractCommand
{
    ...
    protected function process()
    {
        ...
        try {
            $this->load->model('extension/tamarapay/payment/tamarapay_console_scan');

            if ($this->console->getInput()->getOption(self::END_TIME)) {
                $this->model_extension_tamarapay_payment_tamarapay_console_scan->scan($this->console->getInput()->getOption(self::START_TIME),
