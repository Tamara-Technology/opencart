...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\TMS\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\TMS\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\TMS\Psr\Http\Message\RequestInterface $request, array $options, \TMS\Psr\Http\Message\ResponseInterface $response = null) : \TMS\GuzzleHttp\Promise\PromiseInterface
    {
