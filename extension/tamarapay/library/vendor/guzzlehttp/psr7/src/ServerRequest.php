 ...
 */
class ServerRequest extends \TMS\GuzzleHttp\Psr7\Request implements \TMS\Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    public static function normalizeFiles(array $files)
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \TMS\Psr\Http\Message\UploadedFileInterface) {
    ...
    private static function createUploadedFileFromSpec(array $value)
    {
        ...
        return new \TMS\GuzzleHttp\Psr7\UploadedFile($value['tmp_name'], (int) $value['size'], (int) $value['error'], $value['name'], $value['type']);
    }
    /**
    ...
    public static function fromGlobals()
    {
        ...
        $body = new \TMS\GuzzleHttp\Psr7\CachingStream(new \TMS\GuzzleHttp\Psr7\LazyOpenStream('php://input', 'r+'));
        $protocol = isset($_SERVER['SERVER_PROTOCOL']) ? \str_replace('HTTP/', '', $_SERVER['SERVER_PROTOCOL']) : '1.1';
        $serverRequest = new \TMS\GuzzleHttp\Psr7\ServerRequest($method, $uri, $headers, $body, $protocol, $_SERVER);
    ...
    {
        $uri = new \TMS\GuzzleHttp\Psr7\Uri('');
