 ...
 */
class Uri implements \TMS\Psr\Http\Message\UriInterface
{
    /**
     ...
     * @return bool
     */
    public static function isDefaultPort(\TMS\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isAbsolute(\TMS\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isNetworkPathReference(\TMS\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isAbsolutePathReference(\TMS\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isRelativePathReference(\TMS\Psr\Http\Message\UriInterface $uri)
    {
        return $uri->getScheme() === '' && $uri->getAuthority() === '' && (!isset($uri->getPath()[0]) || $uri->getPath()[0] !== '/');
    }
    /**
     ...
     */
    public static function isSameDocumentReference(\TMS\Psr\Http\Message\UriInterface $uri, \TMS\Psr\Http\Message\UriInterface $base = null)
    {
        if ($base !== null) {
            $uri = \TMS\GuzzleHttp\Psr7\UriResolver::resolve($base, $uri);
    ...
    {
        return \TMS\GuzzleHttp\Psr7\UriResolver::removeDotSegments($path);
    }
    /**
     ...
     */
    public static function resolve(\TMS\Psr\Http\Message\UriInterface $base, $rel)
    {
        if (!$rel instanceof \TMS\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
        return \TMS\GuzzleHttp\Psr7\UriResolver::resolve($base, $rel);
    }
    /**
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\TMS\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\TMS\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $result = self::getFilteredQueryString($uri, [$key]);
     ...
     * @return UriInterface
     */
    public static function withQueryValues(\TMS\Psr\Http\Message\UriInterface $uri, array $keyValueArray)
    {
     ...
     * @return array
     */
    private static function getFilteredQueryString(\TMS\Psr\Http\Message\UriInterface $uri, array $keys)
    {
