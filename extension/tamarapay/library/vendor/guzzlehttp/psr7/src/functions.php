 ...
 */
function str(\TMS\Psr\Http\Message\MessageInterface $message)
{
    return \TMS\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\TMS\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \TMS\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\TMS\Psr\Http\Message\MessageInterface $message)
{
    \TMS\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\TMS\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \TMS\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\TMS\Psr\Http\Message\StreamInterface $source, \TMS\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \TMS\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\TMS\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \TMS\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\TMS\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \TMS\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\TMS\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \TMS\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \TMS\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
