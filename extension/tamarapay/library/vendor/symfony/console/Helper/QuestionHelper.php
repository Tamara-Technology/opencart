...
use TMS\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use TMS\Symfony\Component\Console\Input\InputInterface;
use TMS\Symfony\Component\Console\Input\StreamableInputInterface;
 ...
 */
class QuestionHelper extends \TMS\Symfony\Component\Console\Helper\Helper
{
    private $inputStream;
     ...
     */
    public function ask(\TMS\Symfony\Component\Console\Input\InputInterface $input, \TMS\Symfony\Component\Console\Output\OutputInterface $output, \TMS\Symfony\Component\Console\Question\Question $question)
    {
        ...
        if ($input instanceof \TMS\Symfony\Component\Console\Input\StreamableInputInterface && ($stream = $input->getStream())) {
        ...
        } catch (\TMS\Symfony\Component\Console\Exception\MissingInputException $exception) {
     ...
     */
    private function doAsk(\TMS\Symfony\Component\Console\Output\OutputInterface $output, \TMS\Symfony\Component\Console\Question\Question $question)
    {
        ...
        if (null === $autocomplete || !self::$stty || !\TMS\Symfony\Component\Console\Terminal::hasSttyAvailable()) {
            ...
            if ($question->isHidden()) {
                ...
                } catch (\TMS\Symfony\Component\Console\Exception\RuntimeException $e) {
        ...
        if ($output instanceof \TMS\Symfony\Component\Console\Output\ConsoleSectionOutput) {
     ...
     * @return mixed
     */
    private function getDefaultAnswer(\TMS\Symfony\Component\Console\Question\Question $question)
    {
        ...
        } elseif ($question instanceof \TMS\Symfony\Component\Console\Question\ChoiceQuestion) {
     ...
     */
    protected function writePrompt(\TMS\Symfony\Component\Console\Output\OutputInterface $output, \TMS\Symfony\Component\Console\Question\Question $question)
    {
        $message = $question->getQuestion();
        if ($question instanceof \TMS\Symfony\Component\Console\Question\ChoiceQuestion) {
     ...
     */
    protected function writeError(\TMS\Symfony\Component\Console\Output\OutputInterface $output, \Exception $error)
    {
    ...
    private function autocomplete(\TMS\Symfony\Component\Console\Output\OutputInterface $output, \TMS\Symfony\Component\Console\Question\Question $question, $inputStream, callable $autocomplete) : string
    {
        ...
        $output->getFormatter()->setStyle('hl', new \TMS\Symfony\Component\Console\Formatter\OutputFormatterStyle('black', 'white'));
        // Read a keypress
        while (!\feof($inputStream)) {
            ...
            if (\false === $c || '' === $ret && '' === $c && null === $question->getDefault()) {
                ...
                ++$i;
                $tempRet = $ret;
                if ($question instanceof \TMS\Symfony\Component\Console\Question\ChoiceQuestion && $question->isMultiselect()) {
     ...
     * @throws RuntimeException In case the fallback is deactivated and the response cannot be hidden
     */
    private function getHiddenResponse(\TMS\Symfony\Component\Console\Output\OutputInterface $output, $inputStream, bool $trimmable = \true) : string
    {
        ...
        if (self::$stty && \TMS\Symfony\Component\Console\Terminal::hasSttyAvailable()) {
            $sttyMode = \shell_exec('stty -g');
            \shell_exec('stty -echo');
        } elseif ($this->isInteractiveInput($inputStream)) {
            throw new \TMS\Symfony\Component\Console\Exception\RuntimeException('Unable to hide the response.');
        }
     ...
     */
    private function validateAttempts(callable $interviewer, \TMS\Symfony\Component\Console\Output\OutputInterface $output, \TMS\Symfony\Component\Console\Question\Question $question)
    {
        $error = null;
